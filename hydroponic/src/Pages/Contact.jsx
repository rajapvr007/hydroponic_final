...
import Contact_Img from '../assets/contact_img1.png'
          ...
          <section class="  w-full m-96">
            <div class="grid grid-cols-1 lg:grid-cols-2">
                <div class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
                    <div class="absolute inset-0">
                        <img class="object-cover object-top w-full h-full" src={Contact_Img} alt="" />
                    </div>
                </div>

                <div class="flex items-center justify-center sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                    <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                        <h2 class="text-3xl font-bold leading-tight text-white sm:text-4xl">Sign in to Celebration</h2>
                        <p class="mt-2 text-base text-white">Don’t have an account? <a href="#" title="" class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-200 focus:text-blue-200 hover:underline">Create a free account</a></p>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <div class="flex items-center justify-between">
                                        <label for="" class="text-base font-medium text-white"> Password </label>
                        ...
                        <div class="mt-3 space-y-3">
                            <button
                                type="button"
                                class="relative inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-white border-2 border-gray-200 rounded-md hover:bg-gray-100 focus:bg-gray-100 hover:text-black focus:text-black focus:outline-none"
                            >
